const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./_virtual_cosmos-imports-B7-Rk5-J.js","./_virtual_cosmos-imports-DYycp8pU.css"])))=>i.map(i=>d[i]);
...
async function mount() {
  const args = await __vitePreload(() => import("./_virtual_cosmos-imports-B7-Rk5-J.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
