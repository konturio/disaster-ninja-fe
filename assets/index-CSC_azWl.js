const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./_virtual_cosmos-imports-DBAj3ux2.js","./_virtual_cosmos-imports-Z80cRvs0.css"])))=>i.map(i=>d[i]);
...
async function mount() {
  const args = await __vitePreload(() => import("./_virtual_cosmos-imports-DBAj3ux2.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
