...
const DrawPolygonByDraggingMode = memo(
  (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="24" height="24" viewBox="0 0 24 24" {...props}>
      ...
      <path
        d="M20.5962 22.0633C9.01493 18.4815 6.92213 24.8838 3.52276 17.6457"
        stroke="currentColor"
        strokeLinecap="round"
        fill="none"
      />
...
DrawPolygonByDraggingMode.displayName = 'DrawPolygonByDraggingMode';

export default DrawPolygonByDraggingMode;
