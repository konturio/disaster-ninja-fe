...
const DrawEllipseUsingThreePointsMode = memo(
    ...
    <svg width="24" height="24" viewBox="0 0 24 24" {...props}>
      ...
      >
        <path
          ...
          strokeWidth="2"
        />
        <circle cx="11.5" cy="12.5" r="2.5" fill="#FF0000" />
        <circle cx="4.5" cy="4.5" r="2.5" fill="#FF0000" />
        <circle cx="16.5" cy="6.5" r="2.5" fill="#FF0000" />
      </svg>
    </svg>
  ),
);

DrawEllipseUsingThreePointsMode.displayName = 'DrawEllipseUsingThreePointsMode';

export default DrawEllipseUsingThreePointsMode;
