...
export default {
  About: <StructuredRender styling={_landingCss} markdown={_about} docId="about" />,
  Landing: <StructuredRender styling={_landingCss} markdown={_landing} docId="landing" />,
};

function StructuredRender({ styling, markdown, docId }) {
