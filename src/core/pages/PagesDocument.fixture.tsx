...
configRepoStub.returns({
  ...
  sentryDsn:
    'https://82a788726e8b5cafa3306f7e5d1b78a7@o4506761881255936.ingest.sentry.io/4506770155765760',
          ...
          billingCycles: [
            {
              ...
              billingMethods: [
                {
                  id: 'paypal',
                  billingPlanId: 'P-0H547642C56474941M2LEINI',
                },
              ],
            },
            {
              ...
              billingMethods: [
                {
                  id: 'paypal',
                  billingPlanId: 'P-4UN44378BK9455849M2ISXEI',
                },
              ],
            },
          ],
          ...
          billingCycles: [
            {
              ...
              billingMethods: [
                {
                  id: 'paypal',
                  billingPlanId: 'P-3RK14009NT826393LM2LEJYQ',
                },
              ],
            },
            {
              ...
              billingMethods: [
                {
                  id: 'paypal',
                  billingPlanId: 'P-42G09591GF896810SM2LEJHI',
                },
              ],
            },
          ],
