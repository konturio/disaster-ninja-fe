...
// This creator is a copy of createResourceAtom from ~/utils
// It's a local copy needed to handle logic of areaLayersLegendsAndSources
// Making local copy we make sure no other atoms using resource atom creator affected
 ...
 */
let i = 0;
export function createResourceAtom_WithoutRequestSkip<P, T>(
  fetcher: (params?: P | null) => Promise<T>,
