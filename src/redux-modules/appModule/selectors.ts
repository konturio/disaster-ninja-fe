...
export const activeDrawMode = (s: StateWithAppModule) => s.appModule.activeDrawMode;
...
export const selectedOverlayIndex = (s: StateWithAppModule) => s.appModule.selectedOverlayIndex;
...
export const correlationMatrix = (s: StateWithAppModule) => s.appModule.correlationMatrix;
export const matrixSelection = (s: StateWithAppModule) => s.appModule.matrixSelection;
export const legendCells = (s: StateWithAppModule) => s.appModule.legendCells;
export const colorThemeCurrent = (s: StateWithAppModule) => s.appModule.colorThemeCurrent;
export const showLoadingIndicator = (s: StateWithAppModule) => s.appModule.showLoadingIndicator;
