window.konturAppConfig = {
  ...
  FEATURES_BY_DEFAULT: ['events_list', 'current_event', 'reports', 'current_episode', 'episode_list', 'osm_edit_link', 'side_bar',
    'analytics_panel', 'map_layers_panel', 'focused_geometry_layer', 'map_ruler', 'boundary_selector', 'draw_tools', 'geometry_uploader',
    'legend_panel', 'url_store', 'feature_settings', 'layers_in_area', 'toasts', 'interactive_map', 'feed_selector', 'header',
    'intercom', 'geocoder', 'communities', 'tooltip'],
